...
export const metadata: Metadata = {
  title: `FAQ — CareCircle`,
  description: `Frequently asked questions about CareCircle.`,
};
  ...
  return (
    <>
      ...
      <main className="flex-1 mx-auto max-w-3xl px-6 py-12">
        ...
        <p className="text-text-secondary mb-8">Find answers to common questions about CareCircle.</p>
